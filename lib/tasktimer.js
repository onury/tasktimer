...
var utils = {
    ...
    setImmediate: function (cb) {
        ...
        if (utils.BROWSER) { // tested separately
            return setTimeout(cb.bind.apply(cb, [null].concat(args)), 0);
        }
